...
func (EventBroadcast_Priority) EnumDescriptor() ([]byte, []int) {
	return file_event_payloads_v1_proto_rawDescGZIP(), []int{1, 0}
}
...
type EventBroadcast struct {
	...
	RecepientIds  []string                `protobuf:"bytes,2,rep,name=recepient_ids,json=recepientIds,proto3" json:"recepient_ids,omitempty"`
...
func (x *EventBroadcast) GetRecepientIds() []string {
	if x != nil {
		return x.RecepientIds
	}
	return nil
}
...
type EventDelivery struct {
	...
	RecepientId string `protobuf:"bytes,2,opt,name=recepient_id,json=recepientId,proto3" json:"recepient_id,omitempty"`
...
func (x *EventDelivery) GetRecepientId() string {
	if x != nil {
...
func (x *EventDelivery) GetDeviceId() string {
	if x != nil {
		return x.DeviceId
	}
	return ""
...
const file_event_payloads_v1_proto_rawDesc = "" +
	...
	"\rrecepient_ids\x18\x02 \x03(\tR\frecepientIds\x12>\n" +
	"\bpriority\x18\x03 \x01(\x0e2\".events.v1.EventBroadcast.PriorityR\bpriority\" \n" +
	"\bPriority\x12\n" +
	"\n" +
	"\x06NORMAL\x10\x00\x12\b\n" +
	"\x04HIGH\x10\x01\"\xf4\x01\n" +
	"\rEventDelivery\x12*\n" +
	"\x05event\x18\x01 \x01(\v2\x14.events.v1.EventLinkR\x05event\x12!\n" +
	"\frecepient_id\x18\x02 \x01(\tR\vrecepientId\x121\n" +
	...
	"retryCount\x12\x1b\n" +
	"\tdevice_id\x18\x06 \x01(\tR\bdeviceIdB\x98\x01\n" +
...
var file_event_payloads_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_event_payloads_v1_proto_goTypes = []any{
	...
	(*EventBroadcast)(nil),        // 3: events.v1.EventBroadcast
	(*EventDelivery)(nil),         // 4: events.v1.EventDelivery
...
var file_event_payloads_v1_proto_depIdxs = []int32{
	...
	5, // 1: events.v1.EventLink.created_at:type_name -> google.protobuf.Timestamp
	2, // 2: events.v1.EventBroadcast.event:type_name -> events.v1.EventLink
	1, // 3: events.v1.EventBroadcast.priority:type_name -> events.v1.EventBroadcast.Priority
	2, // 4: events.v1.EventDelivery.event:type_name -> events.v1.EventLink
	6, // 5: events.v1.EventDelivery.payload:type_name -> google.protobuf.Struct
